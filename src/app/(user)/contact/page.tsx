...
export default function ContactPage() {
  return (
    <div className="w-full max-h-[screen] relative">
      ...
      />
      <div className="absolute top-0 w-full h-full bg-black/40 text-gray-100 flex flex-col items-center justify-between lg:justify-evenly lg:px-44 text-center px-4">
        <div className="relative lg:w-1/2 lg:h-3/4 w-screen h-[calc(100vh-120px)] p-6  lg:bg-[#111111]/90   text-left lg:rounded-lg  flex flex-col gap-2 lg:gap-4 justify-between lg:p-10">
