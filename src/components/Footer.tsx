...
const Footer = () => {
  return (
    <footer className="w-full lg:p-5 p-5 md:px-20 bg-[#111111]/95 text-gray-100">
      <div className="flex-grow"></div>{" "}
      {/* This div pushes the footer to the bottom */}
      <Container className="flex items-center justify-between h-full">
        <Link href={"/contact"}>
          <p className="hidden md:inline md:text-xl">Contact Me</p>
        </Link>
        ...
        <p className="hidden md:inline text-xl text-gray-100">
