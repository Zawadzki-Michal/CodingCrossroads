...
const Navbar = () => {
  ...
  return (
    <div className='w-full bg-[#111111]/95 h-20 shadow-md'>
    <div className='max-w-screen-xl mx-auto flex items-center justify-between px-4 lg:px-0 h-full'>
      ...
      <div className='hidden md:inline-flex items-center gap-7 text-gray-100 hover:text-gray-400 duration-200'>
        {nav.map((item)=> (
          <Link key={item?.title} href={item?.href} className='text-md uppercase font-semibold relative group overflow-hidden'>
            {item?.title}
